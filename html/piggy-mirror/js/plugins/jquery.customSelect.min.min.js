 ...
 */
!function(e){e.fn.extend({customSelect:function(t){if("undefined"==typeof document.body.style.maxHeight)return this
var s={customClass:"customSelect",mapClass:!0,mapStyle:!0},t=e.extend(s,t),n=t.customClass,o=function(t,s){var n=t.find(":selected"),o=s.children(":first"),c=n.html()||"&nbsp;"
o.html(c),n.attr("disabled")?s.addClass(a("DisabledOption")):s.removeClass(a("DisabledOption")),setTimeout(function(){s.removeClass(a("Open")),e(document).off("mouseup.customSelect")},60)},a=function(e){return n+e}
return this.each(function(){var s=e(this),c=e("<span />").addClass(a("Inner")),l=e("<span />")
s.after(l.append(c)),l.addClass(n),t.mapClass&&l.addClass(s.attr("class")),t.mapStyle&&l.attr("style",s.attr("style")),s.addClass("hasCustomSelect").on("render.customSelect",function(){o(s,l),s.css("width","")
var e=parseInt(s.outerWidth(),10)-(parseInt(l.outerWidth(),10)-parseInt(l.width(),10))
