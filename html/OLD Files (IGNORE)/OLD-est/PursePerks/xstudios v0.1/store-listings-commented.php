    ...
    <div id="inner">
        <div class="container">
            ...
            <div id="shop" class="pull-left">
                <div class="heading">
                    <span>Shop by:</span>
                    <a href="#" title="Deals">Deals</a>
                    <a href="#" title="Stores" class="current">Stores</a>
                    <a href="#" title="Coupons">Coupons</a>
                </div>
<? // included in all_storeslisting // ?>
                <div class="stores">
                    <div class="store col-xs-11 col-sm-5 col-md-5 col-lg-5">
                        <div class="logo pull-left col-xs-3 col-sm-3 col-md-2 col-lg-3">
                            <img src="/img/logo-store.png" class="img-responsive" />
                        </div>
                        <div class="info pull-left col-xs-8 col-sm-8 col-md-9 col-lg-8">
                            <p class="name">Dell.com</p>
                            <p class="total">View 19 Sales and Coupon Codes</p>
                            <div class="savings pull-left">
                                <p class="up">Up to 5.0%</p>
                                <a href="#" class="add_fav"><span class="glyphicon glyphicon-star"></span>Add to Favorites</a>
                            </div>
                            <a href="#" class="button pull-left col-xs-5 col-sm-5 col-md-5 col-lg-12">Shop Now</a>
                            <div class="clearfix"></div>
                        </div>
                        <div class="clearfix"></div>
                    </div>
...
<!-- why an extra div, divs aint free ?? -->			                
            </div>
            <div class="clearfix"></div>
<? //  end include all_storeslisting ?>
