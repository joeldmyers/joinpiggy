...
<? // end include all_store_infotop ?>            
            ...
            <div id="shop" class="pull-left">
                <div class="stores">
<? // include all_store_offersandterms ?>                
                    <section>
                    ...
                    <section class="trending">
                        ...
                        <div class="trending-store col-lg-2 col-md-3 col-sm-5">
                            <a href="">
                                ...
                                <p class="offer"><a href="">Up to 6.0%</a></p>
                            </a>
                        </div>
                        <div class="trending-store col-lg-2 col-md-3 col-sm-5">
                            <a href="">
                                <img class="logo img-responsive" src="/img/lane-bryant.jpg" alt="" />
                                <p class="offer"><a href="">Up to 3.0%</a></p>
                            </a>
                        </div>
                        <div class="trending-store col-lg-2 col-md-3 col-sm-5">
                            <a href="">
                                <img class="logo img-responsive" src="/img/logo-disney.png" alt="" />
                                <p class="offer"><a href="">Up to 1.0%</a></p>
                            </a>
                        </div>
                        <div class="trending-store col-lg-2 col-md-3 col-sm-5">
                            <a href="">
                                <img class="logo img-responsive" src="/img/logo-disney.png" alt="" />
                                <p class="offer"><a href="">Up to 4.0%</a></p>
                            </a>
                        </div>
                        <div class="clearfix"></div>
                    <section>
<? // end include all_store_offersandterms.php ?>                    
                </div>
            </div>
            <div class="clearfix"></div>
        </div>
