...
<html>
    ...
    <div id="cash-back">
        <div class="container">
            <div id="eight-percent" class="col-xs-12 col-sm-12 col-md-4 col-lg-4 pull-left">
                <h1>8.0<span>%</span></h1>
                    <h2>Cash Back</h2>
                    <p><strong>Shop</strong> at your favorite stores<br /> & earn automatic cash back</p>
            </div>
            <div id="sign-up" class="pull-right">
                <h3><strong>Up to 8.0%</strong> cash back just got better thru 04/14</h3>
                <form>
        ...
        <div class="container">
            <div id="ribbon" class="col-xs-9 col-sm-12 col-lg-12">
                ...
                <div id="red-ribbon">
                    ...
                    <span>Click on a brand to earn now!</span>
                </div>
